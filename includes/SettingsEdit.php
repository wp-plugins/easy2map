...
echo '<h5 style="margin-top:20px;border-top:1px solid #EBEBEB;padding-top:0.5em;">Map Template</h5>'
 . '<select onclick="easy2map_map_functions.changeMapTemplate()" size="5" 
...
echo '<h5 style="margin-top:20px;border-top:1px solid #EBEBEB;padding-top:0.5em;">Map Import / Export</h5>';
if (intval($mapID) > 0) {
...
if ($premiumYN === false) {
    ...
    echo '<h5><a href="#" onclick="document.formImport.submit()">Import map &amp; markers</a></h5>';
    
    if (intval($mapID) > 0) {
        echo '<h5><a href="#" onclick="document.formImport2.submit()">Import markers only</a></h5>';
    }
}
